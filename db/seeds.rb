...
ACTIVITIES = [{
    ...
    description: "Why pizza in Buenos Aires? Gooing back to the roots the Italian food is well integrated into the lifestyle of Buenos Aires. Pasta, 
    strong coffee, and pizza!.",
    zone: "Microcentro",
  ...
  title: "Concert",
  category: "Cultural activities",
  description: "You can catch live music across the city from Monday to Sunday, with styles ranging from urban to electronic, rock to reggae, and classical to hip-hop.",
  zone: "Microcentro",
